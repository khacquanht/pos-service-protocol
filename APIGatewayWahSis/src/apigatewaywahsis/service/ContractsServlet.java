...
import com.service_wahsis.contract_service.ContractsHandler;
 ...
 * @author khiemnv
*/
public class ContractsServlet extends AbstractServlet{
	@Override
	protected void processs(HttpServletRequest req, HttpServletResponse resp, StringBuilder respContent) {
		...
		String data = req.getParameter(DefinedName.PARAM_DATA);
		 if (cmd != null && data != null)
			ContractsHandler.getInstance().process(cmd, data, respContent, vrfContent);
		 else
