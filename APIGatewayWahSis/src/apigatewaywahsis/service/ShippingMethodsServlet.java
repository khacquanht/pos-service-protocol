...
import com.service_wahsis.master_service.ShippingMethodsHandler;
 ...
 * @author khiemnv
 */
public class ShippingMethodsServlet extends AbstractServlet {
    ...
    protected void processs(HttpServletRequest req, HttpServletResponse resp, StringBuilder respContent) {
        try {
            ...
            if (cmd != null && data != null) {
                ShippingMethodsHandler.getInstance().process(cmd, data, respContent, vrfContent);
            } else {
