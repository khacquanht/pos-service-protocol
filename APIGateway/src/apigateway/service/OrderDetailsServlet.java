...
import com.wahsis.order_service.OrderDetailsHandler;
 ...
 * @author khiemnv
*/
public class OrderDetailsServlet extends AbstractServlet{
	@Override
	protected void processs(HttpServletRequest req, HttpServletResponse resp, StringBuilder respContent) {
		...
		String data = req.getParameter(DefinedName.PARAM_DATA);
		 if (cmd != null && data != null)
			OrderDetailsHandler.getInstance().process(cmd, data, respContent, vrfContent);
		 else
