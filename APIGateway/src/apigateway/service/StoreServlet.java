...
import com.wahsis.company_service.StoreHandler;
 ...
 * @author khiemnv
 */
public class StoreServlet extends AbstractServlet {
    ...
    protected void processs(HttpServletRequest req, HttpServletResponse resp, StringBuilder respContent) {
        try {
            ...
            if (cmd != null && data != null) {
                StoreHandler.getInstance().process(cmd, data, respContent, vrfContent);
            } else {
